 ...
 */
    ...
    #define ID_DEFAULT                                                      ((uint16_t) 0x2000 | (ADS131M0X_CHANNEL_COUNT << 8))  // NOTE: May change with future device revisions!
 ...
 */
    ...
    #define CLOCK_XTAL_MASK                                                 ((uint16_t) 0x0080)
    #define CLOCK_XTAL_DISABLED                                             ((uint16_t) 0x0001 << 7)
    #define CLOCK_XTAL_EANBLED                                              ((uint16_t) 0x0000 << 7)

    #define CLOCK_EXTREF_MASK                                               ((uint16_t) 0x0040)
    #define CLOCK_EXTREF_DISABLED                                           ((uint16_t) 0x0000 << 6)
    #define CLOCK_EXTREF_ENABLED                                            ((uint16_t) 0x0001 << 6)

    /* RESERVED1 field mask */
    #define CLOCK_RESERVED_MASK                                             ((uint16_t) 0x0020)
    ...
    #define CLOCK_OSR_16256                                                 ((uint16_t) 0x0007 << 2)
