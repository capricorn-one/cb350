...
#ifndef _SPI_DMA_H_INCLUDED
#define _SPI_DMA_H_INCLUDED
...
class SPIClass {
  ...
  // ADDED CODE FOR CALLBACK ON TRANSMISSION COMPLETE
  void set_receive_complete_callback(void (*receive_complete_callback)(void)) {
    receive_complete_callback_function = receive_complete_callback;
    }

  void receive_complete_callback(void) {
    if (receive_complete_callback_function) {
      receive_complete_callback_function();
      }
    }
  private:
  ...
  // ADDED CODE FOR CALLBACK ON TRANSMISSION COMPLETE
  void (*receive_complete_callback_function)(void);
};
